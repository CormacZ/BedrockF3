...
std::expected<std::shared_ptr<ll::event::ListenerBase>, std::string> registerToggleKey() {
    auto& bus = ll::event::EventBus::getInstance();
    auto listener = bus.emplaceListener<ll::event::input::KeyInputEvent>([](ll::event::input::KeyInputEvent& ev) {
